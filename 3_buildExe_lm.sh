...
#Added as part of multi Repo build support on 27th July 2018
    ...
    #docker build --build-arg prodimage_tag=$prodimage_tag --build-arg source_path=$source_path --build-arg projectName=$projectName --build-arg baseBranch=$baseBranch  -t "$projectName"_sandbox:$baseBranch"_"$prNumber .


    docker build -f  Dockerfile_lm --build-arg prodimage_tag=$prodimage_tag --build-arg source_path=$source_path --build-arg projectName=$projectName --build-arg baseBranch=$baseBranch  -t "$projectName"_sandbox:$baseBranch"_"$prNumber .
